              ...
              <form method="post" action="{{route('programs.update', $program)}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <img src="/storage/{{$program->photo}}" alt="program" height="100px" width="300px">
                  </div>

                  <div class="form-group">
                    <label for="description">Description</label>
                    <input type="text" class="form-control" id="description" name="description" value="{{$program->description}}">
                  </div>
